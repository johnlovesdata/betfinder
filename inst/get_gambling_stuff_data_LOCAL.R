...
projections <-
  ...
  read.csv('https://raw.githubusercontent.com/jimtheflash/gambling_stuff/main/data/02_curated/nba_first_to_score/first_player_to_score.csv.gz') %>%
  # first team to score
  bind_rows(
    read.csv('https://raw.githubusercontent.com/jimtheflash/gambling_stuff/main/data/02_curated/nba_first_to_score/first_team_to_score.csv.gz')) %>%
...
player_data <-
  # rosters
  read.csv('/Users/jim/Documents/gambling_stuff/data/02_curated/nba_rosters/current.csv.gz') %>%
  ...
  # lineups
  left_join(
    read.csv('https://raw.githubusercontent.com/jimtheflash/gambling_stuff/main/data/02_curated/nba_lineups/rotowire.csv') %>%
