get_data_for_dashboard <- function(loc = c('local', 'server')) {
  ...
  # get the right file paths
  # TODO: PUT THIS SHIT IN A CONFIG ASSHOLE
  if (loc == 'local') {
    path_list <- list(
      schedule_path = 'https://raw.githubusercontent.com/jimtheflash/gambling_stuff/main/data/nba_schedules/',
      fpts_proj_path = 'https://raw.githubusercontent.com/jimtheflash/gambling_stuff/main/data/02_curated/nba_first_to_score/first_player_to_score.csv.gz',
      ftts_proj_path = 'https://raw.githubusercontent.com/jimtheflash/gambling_stuff/main/data/02_curated/nba_first_to_score/first_team_to_score.csv.gz',
      rosters_path = '/Users/jim/Documents/gambling_stuff/data/02_curated/nba_rosters/current.csv.gz',
      lineups_path = 'https://raw.githubusercontent.com/jimtheflash/gambling_stuff/main/data/02_curated/nba_lineups/rotowire.csv'
    )
  }
  if (loc == 'server') {
    path_list <- list(
      schedule_path = '/home/john/gambling_stuff/data/nba_schedules/',
      fpts_proj_path = '/home/john/gambling_stuff/data/02_curated/nba_first_to_score/first_player_to_score.csv.gz',
      ftts_proj_path = '/home/john/gambling_stuff/data/02_curated/nba_first_to_score/first_team_to_score.csv.gz',
      rosters_path = '/home/john/gambling_stuff/data/02_curated/nba_rosters/current.csv.gz',
      lineups_path = '/home/john/gambling_stuff/data/02_curated/nba_lineups/rotowire.csv'
    )
  }
  ...
  schedule <- try(read.csv(paste0(path_list$schedule_path, today_fn)))
  # wrap tomorrow's schedule in a try cuz of last games in season errors
  tomorrow <- try(read.csv((paste0(path_list$schedule_path, tomorrow_fn))))
